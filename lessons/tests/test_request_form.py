...
class RequestFormTestCase(TestCase):
    ...
    def test_form_has_necessary_fields(self):
        ...
        self.assertTrue(isinstance(availability_date_field, forms.DateTimeField))
    ...
    #     self.form_input['availability_time'] = '07:59'
    #     form = RequestForm(data=self.form_input)
    ...
    def test_availability_date_must_not_be_blank(self):
        self.form_input['availability_date'] = ''
        form = RequestForm(data=self.form_input)
        self.assertFalse(form.is_valid())

    def test_availability_time_must_not_be_blank(self):
        self.form_input['availability_time'] = ''
        form = RequestForm(data=self.form_input)
        self.assertFalse(form.is_valid())
