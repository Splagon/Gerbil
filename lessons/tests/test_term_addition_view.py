...
class AddTermViewTestCase(TestCase):
    """Unit tests for the Term addition view."""
    ...
    def test_get_term_addition_page(self):
    ...
    def test_unsuccessful_term_addition_via_model_constraints(self):
        self.form_input = {
            "startDate": "2023-3-31",
            "endDate": "2023-3-01"
        }
    ...
    def test_unsuccessful_term_addition_due_to_other_conflicting_term_dates(self):
        self.form_input = {
            "startDate": "2023-1-15",
            "endDate": "2023-2-15"
        }
