# Generated by Django 4.1.2 on 2022-11-29 23:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('availability_date', models.DateField(default=datetime.date.today)),
                ...
                ('status', models.CharField(default='In Progress', editable=False, max_length=50)),
                ('totalPrice', models.CharField(default='Total Price', editable=False, max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='User',
