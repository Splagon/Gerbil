# Generated by Django 3.2.5 on 2022-12-07 13:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instrument', models.CharField(blank=True, choices=[('Violin', 'Violin'), ('Double Bass', 'Double Bass'), ('Cello', 'Cello'), ('Keyboard', 'Keyboard'), ('Piano', 'Piano'), ('Trumpet', 'Trumpet'), ('Other', 'Other')], max_length=180)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adult', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='adult', to='lessons.adult')),
            ],
        ),
    ]
