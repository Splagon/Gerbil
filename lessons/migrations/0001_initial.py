    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_superuser', models.BooleanField(
                    verbose_name='Director Status')),
                ('is_adult', models.BooleanField(
                    default=False, verbose_name='Adult Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interval_between_lessons', models.CharField(
                    choices=[('1', 1), ('2', 2)], max_length=2)),
                ('duration_of_lessons', models.CharField(choices=[
                 ('30', '30'), ('45', '45'), ('60', '60')], max_length=4)),
                ('instrument', models.CharField(blank=True, choices=[
                 ('violin', 'violin'), ('double bass', 'double bass'), ('cello', 'cello')], max_length=180)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adult', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='lessons.adult')),
            ],
        ),
    ]
