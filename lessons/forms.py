...
class RequestForm(forms.ModelForm):
    ...
    class Meta:
        start_date_term = Term.objects.filter(
        ...
        widgets = {
            'availability_date' : widgets.DateInput(format='%d/%m/%Y', attrs={'type' : 'date', 'min': start_date_term, 'max' : start_date_term + datetime.timedelta(days=7) }, ),
