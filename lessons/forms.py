...
class RequestForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'availability_date' : forms.DateInput(attrs={'type' : 'date', 'min': datetime.date.today() } ),
            'availability_time' : forms.TimeInput(attrs={'type' : 'time', 'min': '08:00', 'max': '17:30'}, format='%H:%M:%S'),
